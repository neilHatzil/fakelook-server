...
namespace fakeLook_dal.Migrations
{
    ...
    [Migration("20220314182150_Migration2")]
            ...
            modelBuilder.Entity("fakeLook_models.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 3, 14, 20, 21, 50, 179, DateTimeKind.Local).AddTicks(1076),
                            Description = "post 1",
                            ...
                            UserId = 1,
                            X_Position = 44.297386426473267,
                            Y_Position = 30.826800297074993,
                            Z_Position = 23.983233308427575
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2022, 3, 14, 20, 21, 50, 179, DateTimeKind.Local).AddTicks(1247),
                            Description = "post 2",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 2,
                            X_Position = 43.869408513238561,
                            Y_Position = 41.181428286321719,
                            Z_Position = 32.098816385038646
                        },
                        new
                        {
                            Id = 3,
                            Date = new DateTime(2022, 3, 14, 20, 21, 50, 179, DateTimeKind.Local).AddTicks(1250),
                            Description = "post 3",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 3,
                            X_Position = 33.674769223610028,
                            Y_Position = 23.438622825981703,
                            Z_Position = 42.212867561212278
                        },
                        new
                        {
                            Id = 4,
                            Date = new DateTime(2022, 3, 14, 20, 21, 50, 179, DateTimeKind.Local).AddTicks(1252),
                            Description = "post 4",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 4,
                            X_Position = 10.051693576019611,
                            Y_Position = 49.668069819637289,
                            Z_Position = 29.710728513442746
                        },
                        new
                        {
                            Id = 5,
                            Date = new DateTime(2022, 3, 14, 20, 21, 50, 179, DateTimeKind.Local).AddTicks(1254),
                            Description = "post 5",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 5,
                            X_Position = 26.863160729928044,
                            Y_Position = 24.317390624914463,
                            Z_Position = 25.721390320699673
                        });
                });
