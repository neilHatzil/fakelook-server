...
namespace fakeLook_dal.Migrations
{
    ...
    [Migration("20220314091625_Migration1")]
            ...
            modelBuilder.Entity("fakeLook_models.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 3, 14, 11, 16, 25, 574, DateTimeKind.Local).AddTicks(8925),
                            Description = "post 1",
                            ...
                            UserId = 1,
                            X_Position = 35.894483619845161,
                            Y_Position = 1.4793927861086742,
                            Z_Position = 1.2152104013205323
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2022, 3, 14, 11, 16, 25, 574, DateTimeKind.Local).AddTicks(8972),
                            Description = "post 2",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 2,
                            X_Position = 30.41734441016246,
                            Y_Position = 19.932767388819666,
                            Z_Position = 17.807658911658031
                        },
                        new
                        {
                            Id = 3,
                            Date = new DateTime(2022, 3, 14, 11, 16, 25, 574, DateTimeKind.Local).AddTicks(8976),
                            Description = "post 3",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 3,
                            X_Position = 44.859550246668739,
                            Y_Position = 14.642026576833016,
                            Z_Position = 1.2797874173405666
                        },
                        new
                        {
                            Id = 4,
                            Date = new DateTime(2022, 3, 14, 11, 16, 25, 574, DateTimeKind.Local).AddTicks(8978),
                            Description = "post 4",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 4,
                            X_Position = 18.404362015812204,
                            Y_Position = 17.687425762989502,
                            Z_Position = 28.902186250685798
                        },
                        new
                        {
                            Id = 5,
                            Date = new DateTime(2022, 3, 14, 11, 16, 25, 574, DateTimeKind.Local).AddTicks(8981),
                            Description = "post 5",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 5,
                            X_Position = 16.187076251426223,
                            Y_Position = 20.621380521350137,
                            Z_Position = 45.67429424575127
                        });
                });
